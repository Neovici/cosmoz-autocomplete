import{b as i}from"./iframe-CtrRL-Pq.js";import{o as u}from"./index-Bz2WneQV.js";import{c as e,o as A}from"./data-C0pL76yv.js";import{n as I}from"./index-BmwUeC92.js";import"./index-BVN2f1Bv.js";import"./preload-helper-PPVm8Dsz.js";const{expect:P,userEvent:c,waitFor:D}=__STORYBOOK_MODULE_TEST__,_=(o,l)=>l==null?o:({active:s})=>s?new Promise(t=>setTimeout(()=>t(o),l)):void 0,q=({variant:o,source:l,limit:s,textProperty:t,min:p,label:m="",hint:x,value:v=[],disabled:y=!1,placeholder:g="",defaultIndex:h=0,showSingle:w=!1,preserveOrder:b=!1,wrap:$=!1,keepOpened:f=!1,keepQuery:z=!1,opened:T=!1,overflowed:C=!1,responseTime:S,lazyOpen:k,invalid:E,errorMessage:O})=>{const B={maxWidth:C?"170px":"initial"},R=_(l,S);return i`

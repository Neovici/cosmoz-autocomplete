import{b as F}from"./iframe-B6JCXGsP.js";import"./index-C0vGfAoP.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DM9K4UCN.js";const{expect:n,fn:l,userEvent:c,waitFor:i}=__STORYBOOK_MODULE_TEST__,W=({source:e,value:t,limit:a,textProperty:s="text",valueProperty:r,onChange:k,onText:C,onSelect:T,disabled:q,defaultIndex:E,text:z,keepOpened:O,externalSearch:A})=>F`
    <cosmoz-autocomplete
        .source=${e}
        .value=${t}
        .limit=${a}
        ...
        ?external-search=${A}
    ></cosmoz-autocomplete>
`,G={title:"Tests/Autocomplete",render:W,tags:["!autodocs"]},o=[{text:"Red"},{text:"Green"},{text:"Blue"},{text:"Yellow"}],u={args:{source:o,value:[o[0],o[2]]},play:async({canvas:e})=>{await e.findByShadowText(/Red/u),await e.findByShadowText(/Blue/u);const t=document.querySelector("cosmoz-autocomplete");n(t?.shadowRoot?.querySelectorAll(".chip").length).toBe(2)}},p={args:{source:o,value:[o[1]],limit:1},play:async({canvas:e})=>{await e.findByShadowText(/Green/u);const t=document.querySelector("cosmoz-autocomplete");n(t?.shadowRoot?.querySelectorAll(".chip").length).toBe(1)}},d={args:{source:o,value:[]},play:async({canvas:e})=>{const t=await e.findByShadowRole("textbox");await c.click(t);const a=await e.findByShadowRole("option",{name:/Red/u});n(a).toBeTruthy()}},m={args:{source:o,value:[o[0]],onChange:l()},play:async({canvas:e,args:t})=>{await e.findByShadowText(/Red/u);const r=document.querySelector("cosmoz-autocomplete").shadowRoot?.querySelector("cosmoz-autocomplete-chip")?.shadowRoot?.querySelector(".clear");n(r).toBeTruthy(),await c.click(r),await i(()=>{n(t.onChange).toHaveBeenCalledWith([],n.any(Function))})}},y={args:{source:o,value:[],onChange:l(),keepOpened:!0},play:async({canvas:e,args:t})=>{const a=await e.findByShadowRole("textbox");await c.click(a);const s=await e.findByShadowRole("option",{name:/Red/u});await c.click(s),await i(()=>{n(t.onChange).toHaveBeenCalledWith([o[0]],n.any(Function))})}},w={args:{source:o,value:[],onText:l()},play:async({canvas:e,args:t})=>{const a=await e.findByShadowRole("textbox");await c.type(a,"Gre"),await i(()=>{n(t.onText).toHaveBeenCalledWith("Gre")})}},h={args:{source:o,value:[o[0],o[1]],onChange:l()},play:async({canvas:e,args:t})=>{await e.findByShadowText(/Red/u),await e.findByShadowText(/Green/u);const a=await e.findByShadowRole("textbox");await c.click(a),await c.keyboard("{Backspace}"),await i(()=>{n(t.onChange).toHaveBeenCalledWith([o[0]],n.any(Function))})}},x={args:{source:o,value:[],onChange:l()},play:async({canvas:e,args:t})=>{const a=await e.findByShadowRole("textbox");await c.click(a),await e.findByShadowRole("option",{name:/Red/u}),await c.keyboard("{ArrowDown}"),await c.keyboard("{Enter}"),await i(()=>{n(t.onChange).toHaveBeenCalled()})}},S={args:{source:o,value:[],defaultIndex:-1},play:async()=>{const e=document.querySelector("cosmoz-autocomplete");n(e?.shadowRoot?.querySelectorAll(".chip").length??0).toBe(0)}},v={args:{source:o,value:[o[0]],disabled:!0},play:async({canvas:e})=>{await e.findByShadowText(/Red/u);const t=document.querySelector("cosmoz-autocomplete");n(t?.hasAttribute("disabled")).toBe(!0);const a=t?.shadowRoot?.querySelector("cosmoz-input");n(a?.hasAttribute("disabled")).toBe(!0)}},g={args:{source:o,value:[o[0]],text:"initial"},play:async({canvas:e})=>{await e.findByShadowText(/Red/u);const a=document.querySelector("cosmoz-autocomplete").shadowRoot?.querySelector("cosmoz-input");n(a).toBeTruthy()}},B={args:{source:o,value:[],externalSearch:!0,keepOpened:!0},play:async({canvas:e})=>{const t=await e.findByShadowRole("textbox");await c.click(t),await c.type(t,"Red"),await i(()=>{const r=document.querySelector("cosmoz-autocomplete").shadowRoot?.querySelector("cosmoz-listbox")?.shadowRoot?.querySelectorAll('.item[role="option"]');n(r?.length).toBe(4)})}},R={args:{source:[{id:1,text:"Item 1"},{id:2,text:"Item 2"}],value:[{id:1,text:"Item 1"}],valueProperty:"id",keepOpened:!0},play:async({canvas:e})=>{const t=await e.findByShadowRole("textbox");await c.click(t),await i(()=>{const r=document.querySelector("cosmoz-autocomplete").shadowRoot?.querySelector("cosmoz-listbox")?.shadowRoot?.querySelectorAll('.item[role="option"]');n(r?.length).toBe(2)})}},b={args:{source:o,value:[],onSelect:l(),keepOpened:!0},play:async({canvas:e,args:t})=>{const a=await e.findByShadowRole("textbox");await c.click(a);const s=await e.findByShadowRole("option",{name:/Red/u});await c.click(s),await i(()=>{n(t.onSelect).toHaveBeenCalledWith(o[0],n.any(Object))})}},f={args:{source:o,value:[o[0]],limit:1,onChange:l()},play:async({canvas:e,args:t})=>{await e.findByShadowText(/Red/u);const a=await e.findByShadowRole("textbox");await c.click(a),await c.keyboard("{Backspace}"),await new Promise(s=>setTimeout(s,200)),n(t.onChange).not.toHaveBeenCalled()}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  args: {
    source: colors,
...
}`,...f.parameters?.docs?.source}}};const L=["RenderWithValue","RenderLimit1","FocusOpensListbox","DeselectChip","OnChangeCallback","OnTextCallback","BackspaceRemovesChip","KeyboardSelectItem","DefaultIndexNegative","DisabledState","TextValueEffects","ExternalSearchMode","ValueProperty","OnSelectCallback","Limit1DisablesBackspace"];export{h as BackspaceRemovesChip,S as DefaultIndexNegative,m as DeselectChip,v as DisabledState,B as ExternalSearchMode,d as FocusOpensListbox,x as KeyboardSelectItem,f as Limit1DisablesBackspace,y as OnChangeCallback,b as OnSelectCallback,w as OnTextCallback,p as RenderLimit1,u as RenderWithValue,g as TextValueEffects,R as ValueProperty,L as __namedExportsOrder,G as default};

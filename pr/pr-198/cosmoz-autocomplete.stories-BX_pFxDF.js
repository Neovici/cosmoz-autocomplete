...
customElements.define("cosmoz-listbox", connectable(component(Listbox, { styleSheets: [sheet(style$2)] })));
...
`;
customElements.define("cosmoz-autocomplete-skeleton-span", component(() => E, { styleSheets: [style$1] }));

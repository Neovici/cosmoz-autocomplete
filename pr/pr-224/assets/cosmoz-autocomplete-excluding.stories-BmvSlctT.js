import{u as b,a as w,b as m,A as I}from"./iframe-CGsgARI7.js";import{c as L,u as h,i as M,a as j,n as v,o as D}from"./index-FoZG5IOF.js";import{s as F,o as N,A as G,a as y}from"./index-CUnx82uu.js";import{c as p}from"./data-HVObiSIc.js";import"./preload-helper-PPVm8Dsz.js";const K="data:image/svg+xml,%3Csvg width='11' height='11' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 2.5L8.5 8.5M8.5 2.5L2.5 8.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E",Q=L`
...
`,f=o=>({item:o,excluded:!1}),T=o=>o.item,U=o=>{const[e,t]=b(o),c=h(s=>t(r=>{const l=M(s,r?.map(T));if(!l)return;if(!r)return l.map(f);const a=r.reduce((n,u)=>l.includes(u.item)?[...n,u]:u.excluded?n:[...n,{...u,excluded:!0}],[]),i=l.filter(n=>!r.some(u=>u.item===n)).map(f);return[...a,...i]}),[]);return{value:e,setExcludingValue:c,setValue:t}},W=(o,e)=>o?.some(t=>t.item===e&&t.excluded),k=(o,e)=>e&&W(o,e)?"excluded":I,Y=o=>(e,t,{highlight:c,select:s,textual:r,isSelected:l})=>{const a=r(e);return m`<div
				class="item"
				role="option"
				part="option ${k(o,e)}"
				?aria-selected=${l(e)}
			...
			<div class="sizer" virtualizer-sizer>${a}</div>`},J=(o,e)=>({item:t,content:c,disabled:s,hidden:r,className:l="chip",slot:a})=>m`<cosmoz-autocomplete-chip
			class=${y(l)}
			slot=${y(a)}
			part="chip"
		...
		>
			${c}
		</cosmoz-autocomplete-chip>`,X=o=>{const{value:e,setValue:t,setExcludingValue:c}=U("value"),[s,r]=b("text"),l=h(a=>t(i=>i?.filter(n=>n.item!==a)),[]);return G({...o,value:w(()=>e?.map(T),[e]),onChange:h(a=>{c(a)},[]),text:s,onText:h(a=>{r(a)},[]),itemRenderer:w(()=>Y(e),[e]),chipRenderer:w(()=>J(e,l),[e,l])})};customElements.define("cosmoz-autocomplete-excluding",j(X,{observedAttributes:N,styleSheets:[F,Q]}));const{expect:S,userEvent:d,waitFor:Z}=__STORYBOOK_MODULE_TEST__,ee=m`
    <style>
        .custom-message {
            font-size: 14px;
            font-weight: 500;
...
`,oe=(o,e)=>e==null?o:({active:t})=>t?new Promise(c=>setTimeout(()=>c(o),e)):void 0,te=({source:o,limit:e,textProperty:t,min:c,label:s="",value:r=[],disabled:l=!1,placeholder:a="",defaultIndex:i=0,showSingle:n=!1,preserveOrder:u=!1,wrap:z=!1,keepOpened:$=!1,keepQuery:C=!1,overflowed:B=!1,responseTime:E,contour:R,excludedBgColor:O,excludedChipColor:A,excludedChipClearBgColor:V,excludedChipClearStrokeColor:q,excludedListboxActiveColor:_})=>{const P={maxWidth:B?"170px":"initial","--cosmoz-autocomplete-excluded-bg-color":O,"--cosmoz-autocomplete-excluded-chip-color":A,"--cosmoz-autocomplete-excluded-chip-clear-bg-color":V,"--cosmoz-autocomplete-excluded-chip-clear-stroke":q,"--cosmoz-listbox-excluded-active-color":_},H=oe(o,E);return m`
        ${ee}
...
}`,...g.parameters?.docs?.source}}};const ue=["Basic","InteractionTest"];export{x as Basic,g as InteractionTest,ue as __namedExportsOrder,ne as default};

import{c as I,u as f,a as h,i as L,b as M,d as w,e as m,A as j}from"./iframe-C6m2kLkU.js";import{s as D,o as F,A as N,a as y,c as p,n as v,b as G}from"./data-D5-Ds8nA.js";import"./preload-helper-PPVm8Dsz.js";const K="data:image/svg+xml,%3Csvg width='11' height='11' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 2.5L8.5 8.5M8.5 2.5L2.5 8.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E",Q=I`
...
`,b=o=>({item:o,excluded:!1}),T=o=>o.item,U=o=>{const[e,t]=f(o),c=h(r=>t(s=>{const l=L(r,s?.map(T));if(!l)return;if(!s)return l.map(b);const a=s.reduce((n,u)=>l.includes(u.item)?[...n,u]:u.excluded?n:[...n,{...u,excluded:!0}],[]),i=l.filter(n=>!s.some(u=>u.item===n)).map(b);return[...a,...i]}),[]);return{value:e,setExcludingValue:c,setValue:t}},W=(o,e)=>o?.some(t=>t.item===e&&t.excluded),k=(o,e)=>e&&W(o,e)?"excluded":j,Y=o=>(e,t,{highlight:c,select:r,textual:s,isSelected:l})=>{const a=s(e);return m`<div
				class="item"
				role="option"
				part="option ${k(o,e)}"
				?aria-selected=${l(e)}

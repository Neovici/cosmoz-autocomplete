import{E as P,x as i}from"./iframe-BcNmgS0o.js";import{u as g,a as m,i as R,c as _,b as j,s as L,o as D,A as M,d as x,n as h,e as f,f as q}from"./data-BFW3CZoB.js";const b=o=>({item:o,excluded:!1}),v=o=>o.item,G=o=>{const[e,t]=g(o),r=m(a=>t(l=>{const s=R(a,l?.map(v));if(!s)return;if(!l)return s.map(b);const c=l.reduce((n,d)=>s.includes(d.item)?[...n,d]:d.excluded?n:[...n,{...d,excluded:!0}],[]),u=s.filter(n=>!l.some(d=>d.item===n)).map(b);return[...c,...u]}),[]);return[e,r,t]},Q="data:image/svg+xml,%3Csvg width='11' height='11' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 2.5L8.5 8.5M8.5 2.5L2.5 8.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E",W=_`
...
`,U=(o,e)=>e==null?o:({active:t})=>t?new Promise(r=>setTimeout(()=>r(o),e)):void 0,X=({source:o,limit:e,textProperty:t,min:r,label:a="",value:l=[],disabled:s=!1,placeholder:c="",defaultIndex:u=0,showSingle:n=!1,preserveOrder:d=!1,wrap:$=!1,keepOpened:z=!1,keepQuery:k=!1,overflowed:w=!1,responseTime:C,contour:T,excludedBgColor:S,excludedChipColor:A,excludedChipClearBgColor:E,excludedChipClearStrokeColor:V,excludedListboxActiveColor:B})=>{const I={maxWidth:w?"170px":"initial","--cosmoz-autocomplete-excluded-bg-color":S,"--cosmoz-autocomplete-excluded-chip-color":A,"--cosmoz-autocomplete-excluded-chip-clear-bg-color":E,"--cosmoz-autocomplete-excluded-chip-clear-stroke":V,"--cosmoz-listbox-excluded-active-color":B},O=U(o,C);return i`
        ${N}

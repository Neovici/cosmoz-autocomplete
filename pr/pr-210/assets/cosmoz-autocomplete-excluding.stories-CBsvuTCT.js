import{E as I,x as u}from"./iframe-BRm-BSgf.js";import{u as b,a as m,i as O,c as P,s as S,o as R,A as V,b as x,n as $,d as f,e as _}from"./data-BsyUjUoL.js";const h=o=>({item:o,excluded:!1}),y=o=>o.item,j=o=>{const[e,t]=b(o),s=m(c=>t(n=>{const l=O(c,n?.map(y));if(!l)return;if(!n)return l.map(h);const r=n.reduce((a,d)=>l.includes(d.item)?[...a,d]:d.excluded?a:[...a,{...d,excluded:!0}],[]),i=l.filter(a=>!n.some(d=>d.item===a)).map(h);return[...r,...i]}),[]);return[e,s,t]},B=(o,e)=>o?.some(t=>t.item===e&&t.excluded),g=(o,e)=>e&&B(o,e)?"excluded":I,D=o=>(e,t,{highlight:s,select:c,textual:n,isSelected:l})=>{const r=n(e);return u`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${l(e)}
		...
		>
			${s}
		</cosmoz-autocomplete-chip>`,Q=o=>{const[e,t,s]=j("value"),[c,n]=b("text"),l=m(r=>s(i=>i?.filter(a=>a.item!==r)),[]);return V({...o,value:e?.map(y),onChange:m(r=>{t(r)},[]),text:c,onText:m(r=>{n(r)},[]),itemRenderer:D(e),chipRenderer:q(e,l)})};customElements.define("cosmoz-autocomplete-excluding",P(Q,{observedAttributes:R,styleSheets:[S]}));const W=u`
    <style>
...
`,F=(o,e)=>e==null?o:({active:t})=>t?new Promise(s=>setTimeout(()=>s(o),e)):void 0,G=({source:o,limit:e,textProperty:t,min:s,label:c="",value:n=[],disabled:l=!1,placeholder:r="",defaultIndex:i=0,showSingle:a=!1,preserveOrder:d=!1,wrap:v=!1,keepOpened:w=!1,keepQuery:T=!1,overflowed:z=!1,responseTime:k,contour:A})=>{const C={maxWidth:z?"170px":"initial","--cosmoz-autocomplete-excluded-chip-bg-color":"rgb(255, 152, 0)","--cosmoz-listbox-excluded-active-color":"rgba(255, 152, 0, 0.1)"},E=F(o,k);return u`
        ${W}

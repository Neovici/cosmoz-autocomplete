import{T as F,f as De,B as En,E as pt,m as Fe,x as S,i as Sn,p as zn,v as J,r as ht,M as jt,_ as $n}from"./iframe-eEldwc3Q.js";/**
 * @license
 ...
 */const yi=e=>e,wi=(e,t)=>S`${t}: ${JSON.stringify(e,null,2)}`;class xi extends Jt{constructor(t){if(super(t),this._virtualizer=null,this._first=0,this._last=-1,this._renderItem=(n,i)=>wi(n,i+this._first),this._keyFunction=(n,i)=>yi(n,i+this._first),this._items=[],t.type!==H.CHILD)throw new Error("The virtualize directive can only be used in child expressions")}render(t){t&&this._setFunctions(t);const n=[];if(this._first>=0&&this._last>=this._first)for(let i=this._first;i<=this._last;i++)n.push(this._items[i]);return fi(n,this._keyFunction,this._renderItem)}update(t,[n]){this._setFunctions(n);const i=this._items!==n.items;return this._items=n.items||[],this._virtualizer?this._updateVirtualizerConfig(t,n):this._initialize(t,n),i?F:this.render()}async _updateVirtualizerConfig(t,n){if(!await this._virtualizer.updateLayoutConfig(n.layout||{})){const s=t.parentNode;this._makeVirtualizer(s,n)}this._virtualizer.items=this._items}_setFunctions(t){const{renderItem:n,keyFunction:i}=t;n&&(this._renderItem=(s,o)=>n(s,o+this._first)),i&&(this._keyFunction=(s,o)=>i(s,o+this._first))}_makeVirtualizer(t,n){this._virtualizer&&this._virtualizer.disconnected();const{layout:i,scroller:s,items:o}=n;this._virtualizer=new gi({hostElement:t,layout:i,scroller:s}),this._virtualizer.items=o,this._virtualizer.connected()}_initialize(t,n){const i=t.parentNode;i&&i.nodeType===1&&(i.addEventListener("rangeChanged",s=>{this._first=s.first,this._last=s.last,this.setValue(this.render())}),this._makeVirtualizer(i,n))}disconnected(){this._virtualizer?.disconnected()}reconnected(){this._virtualizer?.connected()}}const Ci=rt(xi),Ei=(e=HTMLElement)=>class extends e{connectedCallback(){super.connectedCallback?.(),this.dispatchEvent(new CustomEvent("connected"))}disconnectedCallback(){super.disconnectedCallback?.(),this.dispatchEvent(new CustomEvent("disconnected"))}},Si=(e,t)=>{if(!e||!t)return;const n=Object.keys(t);return Object.fromEntries(Object.keys(e).flatMap(i=>n.includes(i)?[]:[[i,void 0]]))};class zi extends gt{_props;render(t){return F}update(t,[n]){return this._props!==n&&Object.assign(t.element,Si(this._props,n),this._props=n),F}}const $i=rt(zi),ki=e=>{const t=Tt(),n=A(()=>new CSSStyleSheet,[]);z(()=>{t.shadowRoot.adoptedStyleSheets=[...t.shadowRoot.adoptedStyleSheets,n]},[]),z(()=>{n.replaceSync(e)},[e])};function Xe(e){return e?t=>t?.[e]:St}const Ai=e=>{const t=Xe(e);return n=>typeof n=="string"?n:t(n)?.toString()||""},Ri=e=>t=>{const n={};for(const i in t)e.includes(i)&&(n[i]=t[i]);return n},Li="data:image/svg+xml,%3Csvg width='11' height='8' viewBox='0 0 11 8' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M9.5 1L5.20039 7.04766L1.66348 3.46152' stroke='white' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E",Ti="data:image/svg+xml,%3Csvg width='11' height='11' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 2.5L8.5 8.5M8.5 2.5L2.5 8.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E",Oi=$t`
	...
	:host([multi]) .item[aria-selected]::before {
		border-color: #5881f6;
		/* prettier-ignore */
		background: url("${Li}") #5881f6 no-repeat 50%;
	}

	:host([multi]) .item[data-state='excluded']::before {
		border-color: #f44336;
		/* prettier-ignore */
		background: url("${Ti}") #f44336 no-repeat 50%;
	}
...
`,Mi=({index:e,itemHeight:t,auto:n})=>$t`
	${et(!n,()=>$t`
			.item {
				line-height: ${t}px;
				height: ${t}px;
...
`,Pi=e=>typeof e=="object"&&e!==null&&Symbol.iterator in e;function it(e){return e==null?[]:Array.isArray(e)?e:typeof e=="string"?[e]:Pi(e)?Array.from(e):[e]}const Ut=(e,t=St)=>n=>{const i=it(e).map(t);return it(n).filter(s=>!i.includes(t(s)))},Ii=(e,t)=>t?n=>it(e).find(i=>i[t]===n[t]):n=>it(e).includes(n),Di=(e,t)=>{if(!t||!e)return e;const n=e.toLowerCase().indexOf(t.toLowerCase());if(n<0)return e;const i=n+t.length;return[e.slice(0,n),S`<mark>${e.slice(n,i)}</mark>`,e.slice(i)]},vt=e=>{const t=A(()=>({}),[]);return A(()=>Object.assign(t,e),[t,...Object.values(e)])},Fi=e=>{const t=vt(e);z(()=>{const n=i=>{if(!(i.ctrlKey&&i.altKey||i.defaultPrevented))switch(i.key){case"Up":case"ArrowUp":i.preventDefault(),t.onUp();break;case"Down":case"ArrowDown":i.preventDefault(),t.onDown();break;case"Enter":i.preventDefault(),t.onEnter();break}};return document.addEventListener("keydown",n,!0),()=>document.removeEventListener("keydown",n,!0)},[t])},Bi=({items:e,onSelect:t,defaultIndex:n=0})=>{const[i,s]=Q({index:n}),{index:o}=i,{length:r}=e;return z(()=>{s({index:i.index<0?n:Math.min(i.index,e.length-1),scroll:!0})},[e,n]),Fi({onUp:x(()=>s(l=>({index:l.index>0?l.index-1:r-1,scroll:!0})),[r]),onDown:x(()=>s(l=>({index:l.index<r-1?l.index+1:0,scroll:!0})),[r]),onEnter:x(()=>o>-1&&o<r&&t?.(e[o],o),[o,e,t])}),{position:i,highlight:x(l=>s({index:l}),[]),select:x(l=>t?.(l),[t])}},Vi=(e=St)=>(t,n,{highlight:i,select:s,textual:o=St,query:r,isSelected:l})=>{const a=o(t),c=Di(a,r),h=e(c,t,n);return S`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${l(t)}
			...
			<div class="sizer" virtualizer-sizer>${h}</div>`},Ni=({itemRenderer:e=Vi(),...t})=>{const n=vt(t);return x((i,s)=>e(i,s,n),[n,e])},Hi=e=>{const t=e==="auto",[n,i]=Q(t?40:e);return[n,s=>t?i(s):void 0]},ji=["query","items","onSelect","textual","anchor","itemHeight","itemLimit","itemRenderer","defaultIndex","value","valueProperty","loading"],Wi=({value:e,valueProperty:t,items:n,onSelect:i,defaultIndex:s,query:o,textual:r,itemRenderer:l,itemHeight:a=40,itemLimit:c=5})=>{const h=A(()=>Ii(e,t),[e,t]),u=A(()=>n.slice(),[n,h]),{position:f,highlight:d,select:b}=Bi({items:u,onSelect:i,defaultIndex:isNaN(s)?void 0:Number(s)}),[p,g]=Hi(a);return{position:f,items:u,height:Math.min(c,u.length)*p,highlight:d,select:b,itemHeight:p,setItemHeight:g,renderItem:Ni({itemRenderer:l,items:u,position:f,highlight:d,select:b,textual:r,query:o,isSelected:h})}},ze=Tn,Yi=e=>{const t=We(void 0),{position:n,items:i,renderItem:s,height:o,itemHeight:r,setItemHeight:l}=Wi(e);return z(()=>{const a=t.current?.[Qt];a&&a.layoutComplete.then(()=>{e.dispatchEvent(new CustomEvent("layout-complete"));const{averageChildSize:c,averageMarginSize:h}=a._layout._metricsCache;return l(c+h*2)},ze)},[i]),z(()=>{if(!n.scroll)return;const a=t.current?.[Qt];if(a){if(!a?._layout){a.layoutComplete.then(()=>a.element(n.index)?.scrollIntoView({block:"nearest"}),ze);return}a.element(n.index)?.scrollIntoView({block:"nearest"})}},[n]),ki(Mi({...n,itemHeight:r,auto:e.itemHeight==="auto"})),S`<div
			class="items"
		...
		<slot></slot>`};customElements.define("cosmoz-listbox",Ei(lt(Yi,{styleSheets:[ie(Oi)]})));const Ui=({multi:e,setFloating:t,styles:n,...i},s)=>S`<cosmoz-listbox
		style="${An(n)}"
...
`;customElements.define("cosmoz-autocomplete-chip",lt(Qi,{observedAttributes:["disabled"],styleSheets:[ie(qi)]}));const $e=({content:e,onClear:t,disabled:n,hidden:i,className:s="chip",slot:o})=>S`<cosmoz-autocomplete-chip
		class=${P(s)}
		slot=${P(o)}
		part="chip"
	...
	>`,Xi=({value:e,min:t=0,onDeselect:n,textual:i,disabled:s})=>[...e.filter(Boolean).map(o=>$e({content:i(o),onClear:e.length>t&&(()=>n(o)),disabled:s,slot:"control"})),$e({content:S`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],Zi=ne`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
`,ke=e=>e.matches(":focus-within"),Gi=({disabled:e,onFocus:t})=>{const[n,i]=Q(),{focused:s,closed:o}=n||{},r=s&&!e,l=vt({closed:o,onFocus:t}),a=x(h=>i(u=>({...u,closed:h})),[]),c=x(h=>{const u=h.currentTarget;return ke(u)?i(f=>({focused:!0,closed:!f?.closed})):u.focus()},[]);return z(()=>{if(!r)return;const h=u=>{if(u.defaultPrevented)return;const{closed:f}=l;u.key==="Escape"&&!f?(u.preventDefault(),a(!0)):["ArrowUp","Up"].includes(u.key)&&f&&(u.preventDefault(),a(!1))};return document.addEventListener("keydown",h,!0),()=>document.removeEventListener("keydown",h,!0)},[r]),{focused:r,active:r&&!o,setClosed:a,onToggle:c,onFocus:x(h=>{const u=ke(h.currentTarget);i({focused:u}),l.onFocus?.(u)},[l])}},Ji=({focused:e,empty:t,...n})=>{const i=e&&t&&n.limit!==1,s=vt(n);z(()=>{if(!i)return;const o=r=>{if(r.defaultPrevented)return;const{key:l}=r,a=it(s.value),c=s.limit==1;if(a.length>0&&(l==="Backspace"||c&&l.length===1))return s.onChange(a.slice(0,-1))};return document.addEventListener("keydown",o,!0),()=>document.removeEventListener("keydown",o,!0)},[i,s])},Ae=e=>e.normalize("NFD").replace(/[\u0300-\u036f]/gu,""),ts=(e,t,n)=>{if(!t)return e;const i=Ae(t.toLowerCase()),s=[];for(const o of e){const l=Ae(n(o).toLowerCase()).indexOf(i);l<0||s.push({item:o,index:l})}return s.sort((o,r)=>o.index-r.index).map(({item:o})=>o)},es=e=>e===!1||e==null?[]:e,Ze=(e,t,n)=>e.dispatchEvent(new CustomEvent(t,{detail:n})),ns=(e,t,n)=>x(i=>{t?.(i),Ze(e,n,i)},[t]),is=[],ss=e=>(...t)=>{let n;const i=()=>{n&&cancelAnimationFrame(n)};return i(),n=requestAnimationFrame(()=>{n=void 0,e(...t)}),i},se=(e,t=()=>({}))=>{const n={type:e,toString(){return e}};return Object.assign((...s)=>Object.assign(t(...s),n),n)},Re=e=>e.type||e.toString(),Le=e=>Array.isArray(e)?e:[e],os=(e,t)=>{const n=Le(t),i=(n.every(Array.isArray)?n:[n]).map(([s,o])=>({actions:Le(s).map(Re),handle:o}));return(s=e,o)=>{const r=i.find(l=>l.actions.includes(Re(o)));return r?r.handle(s,o):s}},nt={pending:"pending",rejected:"rejected",resolved:"resolved"},Ge={error:void 0,result:void 0,state:nt.pending},Je=se(nt.pending),tn=se(nt.resolved,e=>({result:e})),en=se(nt.rejected,e=>({error:e})),rs=os(Ge,[[Je,()=>({error:void 0,result:void 0,state:nt.pending})],[tn,(e,{result:t})=>({error:void 0,result:t,state:nt.resolved})],[en,(e,{error:t})=>({error:t,result:void 0,state:nt.rejected})]]),ls=e=>{const[{error:t,result:n,state:i},s]=qn(rs,Ge);return z(()=>{if(!e)return;let o=!1;return s(Je()),e.then(r=>!o&&s(tn(r)),r=>!o&&s(en(r))),()=>{o=!0}},[e]),[n,t,i]},as=({value:e,text:t,onChange:n,onText:i,onSelect:s,limit:o,min:r,source:l,textProperty:a,textual:c,valueProperty:h,keepOpened:u,keepQuery:f,preserveOrder:d,defaultIndex:b,externalSearch:p,...g})=>{const m=A(()=>(c??Ai)(a),[c,a]),{active:v,focused:_,onFocus:w,setClosed:y}=Gi(g),$=!t,C=A(()=>t?.trim(),[t]),R=Tt(),k=ns(R,i,"text"),N=x(E=>{n?.(E,()=>y(!0)),Ze(R,"value",E)},[n]),[I,D]=Q([]),U=A(()=>Promise.resolve(typeof l=="function"?l({query:C,active:v}):l).then(es),[l,v,C]),L=A(()=>it(e),[e]);z(()=>U.then(D),[U]),Ji({focused:_,empty:$,limit:o,value:L,onChange:N,onText:k}),z(()=>{_||k("")},[_]);const T=vt({onText:k,onChange:N,value:L,limit:o,min:r,keepQuery:f,keepOpened:u,setClosed:y,onSelect:s}),[,,q]=ls(U);return{active:v,query:C,textual:m,value:L,source$:U,loading:q==="pending",items:A(()=>{if(!v)return is;const E=d?I:[...L,...Ut(L,Xe(h))(I)];return p?E:ts(E,C,m)},[I,v,C,m,$,L,d,h,p]),onClick:x(()=>y(!1),[]),onFocus:w,onText:x(E=>{k(E.target.value),y(!1)},[k,t,y]),onSelect:x(E=>{T.onSelect?.(E,T);const{onChange:Ht,onText:bn,limit:vn,min:_n,value:yn,keepQuery:wn,keepOpened:xn,setClosed:Cn}=T;wn||bn(""),xn||Cn(!0);const yt=it(yn),ue=yt.includes(E);ue&&yt.length===_n||Ht((ue?Ut(E)(yt):[...yt,E]).slice(-vn))},[T]),onDeselect:x(E=>T.onChange(Ut(E)(T.value)),[T]),defaultIndex:C!==void 0&&C?.length>0?0:b}},cs=e=>{const t=e.shadowRoot.querySelectorAll(".chip"),n=e.shadowRoot.querySelector(".badge");n.hidden=!0;for(const l of t)l.hidden=!1;const s=e.shadowRoot.querySelector("cosmoz-input").shadowRoot?.querySelector(".control")?.getBoundingClientRect();let o;for(o=0;o<t.length;o++){const a=t[o].getBoundingClientRect();if(!(a.x+a.width<=s.x+s.width-24))break}const r=t.length-o;for(n.querySelector("span").textContent="+"+r.toString(),n.hidden=r<1;o<t.length;o++)t[o].hidden=!0},us=({value:e,active:t,wrap:n,limit:i})=>{const s=Tt(),o=!(n||i==1),r=A(()=>ss(()=>cs(s)),[]),[l,a]=Q(0);ge(()=>{if(!o)return;const c=s.shadowRoot.querySelector("cosmoz-input"),h=new ResizeObserver(u=>{a(u[0].contentRect.width)});return h.observe(c),()=>h.disconnect()},[o]),ge(()=>o?r():void 0,[o,l,t,e])},K=Math.min,O=Math.max,At=Math.round,Ct=Math.floor,j=e=>({x:e,y:e}),hs={left:"right",right:"left",bottom:"top",top:"bottom"},ds={start:"end",end:"start"};function Te(e,t,n){return O(e,K(t,n))}function It(e,t){return typeof e=="function"?e(t):e}function st(e){return e.split("-")[0]}function Dt(e){return e.split("-")[1]}function nn(e){return e==="x"?"y":"x"}function sn(e){return e==="y"?"height":"width"}function Ft(e){return["top","bottom"].includes(st(e))?"y":"x"}function on(e){return nn(Ft(e))}function fs(e,t,n){n===void 0&&(n=!1);const i=Dt(e),s=on(e),o=sn(s);let r=s==="x"?i===(n?"end":"start")?"right":"left":i==="start"?"bottom":"top";return t.reference[o]>t.floating[o]&&(r=Rt(r)),[r,Rt(r)]}function ps(e){const t=Rt(e);return[Xt(e),t,Xt(t)]}function Xt(e){return e.replace(/start|end/g,t=>ds[t])}function ms(e,t,n){const i=["left","right"],s=["right","left"],o=["top","bottom"],r=["bottom","top"];switch(e){case"top":case"bottom":return n?t?s:i:t?i:s;case"left":case"right":return t?o:r;default:return[]}}function gs(e,t,n,i){const s=Dt(e);let o=ms(st(e),n==="start",i);return s&&(o=o.map(r=>r+"-"+s),t&&(o=o.concat(o.map(Xt)))),o}function Rt(e){return e.replace(/left|right|bottom|top/g,t=>hs[t])}function bs(e){return{top:0,right:0,bottom:0,left:0,...e}}function vs(e){return typeof e!="number"?bs(e):{top:e,right:e,bottom:e,left:e}}function Lt(e){const{x:t,y:n,width:i,height:s}=e;return{width:i,height:s,top:n,left:t,right:t+i,bottom:n+s,x:t,y:n}}function Oe(e,t,n){let{reference:i,floating:s}=e;const o=Ft(t),r=on(t),l=sn(r),a=st(t),c=o==="y",h=i.x+i.width/2-s.width/2,u=i.y+i.height/2-s.height/2,f=i[l]/2-s[l]/2;let d;switch(a){case"top":d={x:h,y:i.y-s.height};break;case"bottom":d={x:h,y:i.y+i.height};break;case"right":d={x:i.x+i.width,y:u};break;case"left":d={x:i.x-s.width,y:u};break;default:d={x:i.x,y:i.y}}switch(Dt(t)){case"start":d[r]-=f*(n&&c?-1:1);break;case"end":d[r]+=f*(n&&c?-1:1);break}return d}const _s=async(e,t,n)=>{const{placement:i="bottom",strategy:s="absolute",middleware:o=[],platform:r}=n,l=o.filter(Boolean),a=await(r.isRTL==null?void 0:r.isRTL(t));let c=await r.getElementRects({reference:e,floating:t,strategy:s}),{x:h,y:u}=Oe(c,i,a),f=i,d={},b=0;for(let p=0;p<l.length;p++){const{name:g,fn:m}=l[p],{x:v,y:_,data:w,reset:y}=await m({x:h,y:u,initialPlacement:i,placement:f,strategy:s,middlewareData:d,rects:c,platform:r,elements:{reference:e,floating:t}});h=v??h,u=_??u,d={...d,[g]:{...d[g],...w}},y&&b<=50&&(b++,typeof y=="object"&&(y.placement&&(f=y.placement),y.rects&&(c=y.rects===!0?await r.getElementRects({reference:e,floating:t,strategy:s}):y.rects),{x:h,y:u}=Oe(c,f,a)),p=-1)}return{x:h,y:u,placement:f,strategy:s,middlewareData:d}};async function oe(e,t){var n;t===void 0&&(t={});const{x:i,y:s,platform:o,rects:r,elements:l,strategy:a}=e,{boundary:c="clippingAncestors",rootBoundary:h="viewport",elementContext:u="floating",altBoundary:f=!1,padding:d=0}=It(t,e),b=vs(d),g=l[f?u==="floating"?"reference":"floating":u],m=Lt(await o.getClippingRect({element:(n=await(o.isElement==null?void 0:o.isElement(g)))==null||n?g:g.contextElement||await(o.getDocumentElement==null?void 0:o.getDocumentElement(l.floating)),boundary:c,rootBoundary:h,strategy:a})),v=u==="floating"?{x:i,y:s,width:r.floating.width,height:r.floating.height}:r.reference,_=await(o.getOffsetParent==null?void 0:o.getOffsetParent(l.floating)),w=await(o.isElement==null?void 0:o.isElement(_))?await(o.getScale==null?void 0:o.getScale(_))||{x:1,y:1}:{x:1,y:1},y=Lt(o.convertOffsetParentRelativeRectToViewportRelativeRect?await o.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:v,offsetParent:_,strategy:a}):v);return{top:(m.top-y.top+b.top)/w.y,bottom:(y.bottom-m.bottom+b.bottom)/w.y,left:(m.left-y.left+b.left)/w.x,right:(y.right-m.right+b.right)/w.x}}const ys=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var n,i;const{placement:s,middlewareData:o,rects:r,initialPlacement:l,platform:a,elements:c}=t,{mainAxis:h=!0,crossAxis:u=!0,fallbackPlacements:f,fallbackStrategy:d="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:p=!0,...g}=It(e,t);if((n=o.arrow)!=null&&n.alignmentOffset)return{};const m=st(s),v=st(l)===l,_=await(a.isRTL==null?void 0:a.isRTL(c.floating)),w=f||(v||!p?[Rt(l)]:ps(l));!f&&b!=="none"&&w.push(...gs(l,p,b,_));const y=[l,...w],$=await oe(t,g),C=[];let R=((i=o.flip)==null?void 0:i.overflows)||[];if(h&&C.push($[m]),u){const D=fs(s,r,_);C.push($[D[0]],$[D[1]])}if(R=[...R,{placement:s,overflows:C}],!C.every(D=>D<=0)){var k,N;const D=(((k=o.flip)==null?void 0:k.index)||0)+1,U=y[D];if(U)return{data:{index:D,overflows:R},reset:{placement:U}};let L=(N=R.filter(T=>T.overflows[0]<=0).sort((T,q)=>T.overflows[1]-q.overflows[1])[0])==null?void 0:N.placement;if(!L)switch(d){case"bestFit":{var I;const T=(I=R.map(q=>[q.placement,q.overflows.filter(E=>E>0).reduce((E,Ht)=>E+Ht,0)]).sort((q,E)=>q[1]-E[1])[0])==null?void 0:I[0];T&&(L=T);break}case"initialPlacement":L=l;break}if(s!==L)return{reset:{placement:L}}}return{}}}},ws=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:n,y:i,placement:s}=t,{mainAxis:o=!0,crossAxis:r=!1,limiter:l={fn:g=>{let{x:m,y:v}=g;return{x:m,y:v}}},...a}=It(e,t),c={x:n,y:i},h=await oe(t,a),u=Ft(st(s)),f=nn(u);let d=c[f],b=c[u];if(o){const g=f==="y"?"top":"left",m=f==="y"?"bottom":"right",v=d+h[g],_=d-h[m];d=Te(v,d,_)}if(r){const g=u==="y"?"top":"left",m=u==="y"?"bottom":"right",v=b+h[g],_=b-h[m];b=Te(v,b,_)}const p=l.fn({...t,[f]:d,[u]:b});return{...p,data:{x:p.x-n,y:p.y-i}}}}},xs=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){const{placement:n,rects:i,platform:s,elements:o}=t,{apply:r=()=>{},...l}=It(e,t),a=await oe(t,l),c=st(n),h=Dt(n),u=Ft(n)==="y",{width:f,height:d}=i.floating;let b,p;c==="top"||c==="bottom"?(b=c,p=h===(await(s.isRTL==null?void 0:s.isRTL(o.floating))?"start":"end")?"left":"right"):(p=c,b=h==="end"?"top":"bottom");const g=d-a.top-a.bottom,m=f-a.left-a.right,v=K(d-a[b],g),_=K(f-a[p],m),w=!t.middlewareData.shift;let y=v,$=_;if(u?$=h||w?K(_,m):m:y=h||w?K(v,g):g,w&&!h){const R=O(a.left,0),k=O(a.right,0),N=O(a.top,0),I=O(a.bottom,0);u?$=f-2*(R!==0||k!==0?R+k:O(a.left,a.right)):y=d-2*(N!==0||I!==0?N+I:O(a.top,a.bottom))}await r({...t,availableWidth:$,availableHeight:y});const C=await s.getDimensions(o.floating);return f!==C.width||d!==C.height?{reset:{rects:!0}}:{}}}};function Bt(){return typeof window<"u"}function ut(e){return rn(e)?(e.nodeName||"").toLowerCase():"#document"}function M(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function Y(e){var t;return(t=(rn(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function rn(e){return Bt()?e instanceof Node||e instanceof M(e).Node:!1}function B(e){return Bt()?e instanceof Element||e instanceof M(e).Element:!1}function W(e){return Bt()?e instanceof HTMLElement||e instanceof M(e).HTMLElement:!1}function Me(e){return!Bt()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof M(e).ShadowRoot}function _t(e){const{overflow:t,overflowX:n,overflowY:i,display:s}=V(e);return/auto|scroll|overlay|hidden|clip/.test(t+i+n)&&!["inline","contents"].includes(s)}function Cs(e){return["table","td","th"].includes(ut(e))}function Vt(e){return[":popover-open",":modal"].some(t=>{try{return e.matches(t)}catch{return!1}})}function re(e){const t=le(),n=B(e)?V(e):e;return n.transform!=="none"||n.perspective!=="none"||(n.containerType?n.containerType!=="normal":!1)||!t&&(n.backdropFilter?n.backdropFilter!=="none":!1)||!t&&(n.filter?n.filter!=="none":!1)||["transform","perspective","filter"].some(i=>(n.willChange||"").includes(i))||["paint","layout","strict","content"].some(i=>(n.contain||"").includes(i))}function Es(e){let t=X(e);for(;W(t)&&!ct(t);){if(re(t))return t;if(Vt(t))return null;t=X(t)}return null}function le(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function ct(e){return["html","body","#document"].includes(ut(e))}function V(e){return M(e).getComputedStyle(e)}function Nt(e){return B(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function X(e){if(ut(e)==="html")return e;const t=e.assignedSlot||e.parentNode||Me(e)&&e.host||Y(e);return Me(t)?t.host:t}function ln(e){const t=X(e);return ct(t)?e.ownerDocument?e.ownerDocument.body:e.body:W(t)&&_t(t)?t:ln(t)}function mt(e,t,n){var i;t===void 0&&(t=[]),n===void 0&&(n=!0);const s=ln(e),o=s===((i=e.ownerDocument)==null?void 0:i.body),r=M(s);if(o){const l=Zt(r);return t.concat(r,r.visualViewport||[],_t(s)?s:[],l&&n?mt(l):[])}return t.concat(s,mt(s,[],n))}function Zt(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function an(e){const t=V(e);let n=parseFloat(t.width)||0,i=parseFloat(t.height)||0;const s=W(e),o=s?e.offsetWidth:n,r=s?e.offsetHeight:i,l=At(n)!==o||At(i)!==r;return l&&(n=o,i=r),{width:n,height:i,$:l}}function ae(e){return B(e)?e:e.contextElement}function at(e){const t=ae(e);if(!W(t))return j(1);const n=t.getBoundingClientRect(),{width:i,height:s,$:o}=an(t);let r=(o?At(n.width):n.width)/i,l=(o?At(n.height):n.height)/s;return(!r||!Number.isFinite(r))&&(r=1),(!l||!Number.isFinite(l))&&(l=1),{x:r,y:l}}const Ss=j(0);function cn(e){const t=M(e);return!le()||!t.visualViewport?Ss:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function zs(e,t,n){return t===void 0&&(t=!1),!n||t&&n!==M(e)?!1:t}function ot(e,t,n,i){t===void 0&&(t=!1),n===void 0&&(n=!1);const s=e.getBoundingClientRect(),o=ae(e);let r=j(1);t&&(i?B(i)&&(r=at(i)):r=at(e));const l=zs(o,n,i)?cn(o):j(0);let a=(s.left+l.x)/r.x,c=(s.top+l.y)/r.y,h=s.width/r.x,u=s.height/r.y;if(o){const f=M(o),d=i&&B(i)?M(i):i;let b=f,p=Zt(b);for(;p&&i&&d!==b;){const g=at(p),m=p.getBoundingClientRect(),v=V(p),_=m.left+(p.clientLeft+parseFloat(v.paddingLeft))*g.x,w=m.top+(p.clientTop+parseFloat(v.paddingTop))*g.y;a*=g.x,c*=g.y,h*=g.x,u*=g.y,a+=_,c+=w,b=M(p),p=Zt(b)}}return Lt({width:h,height:u,x:a,y:c})}function ce(e,t){const n=Nt(e).scrollLeft;return t?t.left+n:ot(Y(e)).left+n}function un(e,t,n){n===void 0&&(n=!1);const i=e.getBoundingClientRect(),s=i.left+t.scrollLeft-(n?0:ce(e,i)),o=i.top+t.scrollTop;return{x:s,y:o}}function $s(e){let{elements:t,rect:n,offsetParent:i,strategy:s}=e;const o=s==="fixed",r=Y(i),l=t?Vt(t.floating):!1;if(i===r||l&&o)return n;let a={scrollLeft:0,scrollTop:0},c=j(1);const h=j(0),u=W(i);if((u||!u&&!o)&&((ut(i)!=="body"||_t(r))&&(a=Nt(i)),W(i))){const d=ot(i);c=at(i),h.x=d.x+i.clientLeft,h.y=d.y+i.clientTop}const f=r&&!u&&!o?un(r,a,!0):j(0);return{width:n.width*c.x,height:n.height*c.y,x:n.x*c.x-a.scrollLeft*c.x+h.x+f.x,y:n.y*c.y-a.scrollTop*c.y+h.y+f.y}}function ks(e){return Array.from(e.getClientRects())}function As(e){const t=Y(e),n=Nt(e),i=e.ownerDocument.body,s=O(t.scrollWidth,t.clientWidth,i.scrollWidth,i.clientWidth),o=O(t.scrollHeight,t.clientHeight,i.scrollHeight,i.clientHeight);let r=-n.scrollLeft+ce(e);const l=-n.scrollTop;return V(i).direction==="rtl"&&(r+=O(t.clientWidth,i.clientWidth)-s),{width:s,height:o,x:r,y:l}}function Rs(e,t){const n=M(e),i=Y(e),s=n.visualViewport;let o=i.clientWidth,r=i.clientHeight,l=0,a=0;if(s){o=s.width,r=s.height;const c=le();(!c||c&&t==="fixed")&&(l=s.offsetLeft,a=s.offsetTop)}return{width:o,height:r,x:l,y:a}}function Ls(e,t){const n=ot(e,!0,t==="fixed"),i=n.top+e.clientTop,s=n.left+e.clientLeft,o=W(e)?at(e):j(1),r=e.clientWidth*o.x,l=e.clientHeight*o.y,a=s*o.x,c=i*o.y;return{width:r,height:l,x:a,y:c}}function Pe(e,t,n){let i;if(t==="viewport")i=Rs(e,n);else if(t==="document")i=As(Y(e));else if(B(t))i=Ls(t,n);else{const s=cn(e);i={x:t.x-s.x,y:t.y-s.y,width:t.width,height:t.height}}return Lt(i)}function hn(e,t){const n=X(e);return n===t||!B(n)||ct(n)?!1:V(n).position==="fixed"||hn(n,t)}function Ts(e,t){const n=t.get(e);if(n)return n;let i=mt(e,[],!1).filter(l=>B(l)&&ut(l)!=="body"),s=null;const o=V(e).position==="fixed";let r=o?X(e):e;for(;B(r)&&!ct(r);){const l=V(r),a=re(r);!a&&l.position==="fixed"&&(s=null),(o?!a&&!s:!a&&l.position==="static"&&!!s&&["absolute","fixed"].includes(s.position)||_t(r)&&!a&&hn(e,r))?i=i.filter(h=>h!==r):s=l,r=X(r)}return t.set(e,i),i}function Os(e){let{element:t,boundary:n,rootBoundary:i,strategy:s}=e;const r=[...n==="clippingAncestors"?Vt(t)?[]:Ts(t,this._c):[].concat(n),i],l=r[0],a=r.reduce((c,h)=>{const u=Pe(t,h,s);return c.top=O(u.top,c.top),c.right=K(u.right,c.right),c.bottom=K(u.bottom,c.bottom),c.left=O(u.left,c.left),c},Pe(t,l,s));return{width:a.right-a.left,height:a.bottom-a.top,x:a.left,y:a.top}}function Ms(e){const{width:t,height:n}=an(e);return{width:t,height:n}}function Ps(e,t,n){const i=W(t),s=Y(t),o=n==="fixed",r=ot(e,!0,o,t);let l={scrollLeft:0,scrollTop:0};const a=j(0);if(i||!i&&!o)if((ut(t)!=="body"||_t(s))&&(l=Nt(t)),i){const f=ot(t,!0,o,t);a.x=f.x+t.clientLeft,a.y=f.y+t.clientTop}else s&&(a.x=ce(s));const c=s&&!i&&!o?un(s,l):j(0),h=r.left+l.scrollLeft-a.x-c.x,u=r.top+l.scrollTop-a.y-c.y;return{x:h,y:u,width:r.width,height:r.height}}function qt(e){return V(e).position==="static"}function Ie(e,t){if(!W(e)||V(e).position==="fixed")return null;if(t)return t(e);let n=e.offsetParent;return Y(e)===n&&(n=n.ownerDocument.body),n}function dn(e,t){const n=M(e);if(Vt(e))return n;if(!W(e)){let s=X(e);for(;s&&!ct(s);){if(B(s)&&!qt(s))return s;s=X(s)}return n}let i=Ie(e,t);for(;i&&Cs(i)&&qt(i);)i=Ie(i,t);return i&&ct(i)&&qt(i)&&!re(i)?n:i||Es(e)||n}const Is=async function(e){const t=this.getOffsetParent||dn,n=this.getDimensions,i=await n(e.floating);return{reference:Ps(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:i.width,height:i.height}}};function Ds(e){return V(e).direction==="rtl"}const Fs={convertOffsetParentRelativeRectToViewportRelativeRect:$s,getDocumentElement:Y,getClippingRect:Os,getOffsetParent:dn,getElementRects:Is,getClientRects:ks,getDimensions:Ms,getScale:at,isElement:B,isRTL:Ds};function Bs(e,t){let n=null,i;const s=Y(e);function o(){var l;clearTimeout(i),(l=n)==null||l.disconnect(),n=null}function r(l,a){l===void 0&&(l=!1),a===void 0&&(a=1),o();const{left:c,top:h,width:u,height:f}=e.getBoundingClientRect();if(l||t(),!u||!f)return;const d=Ct(h),b=Ct(s.clientWidth-(c+u)),p=Ct(s.clientHeight-(h+f)),g=Ct(c),v={rootMargin:-d+"px "+-b+"px "+-p+"px "+-g+"px",threshold:O(0,K(1,a))||1};let _=!0;function w(y){const $=y[0].intersectionRatio;if($!==a){if(!_)return r();$?r(!1,$):i=setTimeout(()=>{r(!1,1e-7)},1e3)}_=!1}try{n=new IntersectionObserver(w,{...v,root:s.ownerDocument})}catch{n=new IntersectionObserver(w,v)}n.observe(e)}return r(!0),o}function Vs(e,t,n,i){i===void 0&&(i={});const{ancestorScroll:s=!0,ancestorResize:o=!0,elementResize:r=typeof ResizeObserver=="function",layoutShift:l=typeof IntersectionObserver=="function",animationFrame:a=!1}=i,c=ae(e),h=s||o?[...c?mt(c):[],...mt(t)]:[];h.forEach(m=>{s&&m.addEventListener("scroll",n,{passive:!0}),o&&m.addEventListener("resize",n)});const u=c&&l?Bs(c,n):null;let f=-1,d=null;r&&(d=new ResizeObserver(m=>{let[v]=m;v&&v.target===c&&d&&(d.unobserve(t),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var _;(_=d)==null||_.observe(t)})),n()}),c&&!a&&d.observe(c),d.observe(t));let b,p=a?ot(e):null;a&&g();function g(){const m=ot(e);p&&(m.x!==p.x||m.y!==p.y||m.width!==p.width||m.height!==p.height)&&n(),p=m,b=requestAnimationFrame(g)}return n(),()=>{var m;h.forEach(v=>{s&&v.removeEventListener("scroll",n),o&&v.removeEventListener("resize",n)}),u?.(),(m=d)==null||m.disconnect(),d=null,a&&cancelAnimationFrame(b)}}const Ns=ws,Hs=ys,js=xs,Ws=(e,t,n)=>{const i=new Map,s={platform:Fs,...n},o={...s.platform,_c:i};return _s(e,t,{...s,platform:o})},fn=[Hs({fallbackAxisSideDirection:"start",crossAxis:!1}),Ns()],Ys=({placement:e="bottom-start",strategy:t,middleware:n=fn}={})=>{const[i,s]=Q(),[o,r]=Q(),[l,a]=Q();return z(()=>{if(!i||!(o instanceof HTMLElement)){a(void 0);return}return Vs(i,o,()=>Ws(i,o,{placement:e,strategy:t,middleware:n}).then(a))},[i,o,e,t,n]),{setReference:s,setFloating:r,styles:A(()=>l?{left:`${l.x}px`,top:`${l.y}px`}:{},[l?.x,l?.y])}},Us=["input","control","label","line","error","wrap"].map(e=>`${e}: input-${e}`).join(),qs=[js({apply({rects:e,elements:t}){Object.assign(t.floating.style,{minWidth:`${Math.max(e.reference.width,e.floating.width)}px`})}}),...fn],Ks=({active:e,isSingle:t,showSingle:n})=>e?!(t&&!n):!1,Qs=e=>{const{active:t,invalid:n,errorMessage:i,label:s,placeholder:o,disabled:r,noLabelFloat:l,alwaysFloatLabel:a,textual:c,text:h,onText:u,onFocus:f,onClick:d,onDeselect:b,value:p,limit:g,min:m,showSingle:v,items:_,source$:w,placement:y,loading:$}=e,C=Tt(),R=g==1,k=R&&p?.[0]!=null,{styles:N,setReference:I,setFloating:D}=Ys({placement:y,middleware:qs});z(()=>(C.addEventListener("focusin",f),C.addEventListener("focusout",f),()=>{C.removeEventListener("focusin",f),C.removeEventListener("focusout",f)}),[f]),ee({focus:()=>C.shadowRoot?.querySelector("#input")?.focus()},[]);const U=$||_.length>0||h!=null&&h.length>0;return S`<cosmoz-input
				id="input"
				part="input"
				${bt(I)}
				.label=${s}
				...
				.errorMessage=${we(w.then(()=>i,L=>L.message),i)}
				.value=${te(h)}
				@value-changed=${u}
				@click=${d}
				autocomplete="off"
			...
			>
				...
				${Xi({value:p,min:m,onDeselect:b,textual:c,disabled:r})}
			</cosmoz-input>

			${et(Ks({active:t,isSingle:k,showSingle:v}),()=>Ui({...e,items:_,multi:!R,setFloating:D,styles:{...N,display:U?void 0:"none"}},et($,()=>S`<cosmoz-autocomplete-skeleton-span></cosmoz-autocomplete-skeleton-span>`,()=>et(h!=null&&h.length>0&&_.length===0,()=>S`<slot name="no-result"></slot>`))))}`},pn=e=>{const t={...e,...as(e)};return us(t),Qs(t)},mn=["disabled","invalid","no-label-float","always-float-label","text-property","value-property","limit","min","show-single","preserve-order","keep-opened","keep-query","default-index","external-search","item-height","item-limit","wrap"],Xs=e=>{const{onChange:t,onText:n,...i}=e,[s,o]=Qn("value");return z(()=>{e.onChange!=null&&console.warn("onChange is deprecated; use value-changed and lift instead")},[]),pn({...i,value:s,onChange:x((r,...l)=>{o(r),t?.(r,...l)},[t]),onText:x(r=>{e.text=r,n?.(r)},[n])})},gn=[ie(Zi)];customElements.define("cosmoz-autocomplete-ui",lt(pn,{observedAttributes:mn,styleSheets:gn}));customElements.define("cosmoz-autocomplete",lt(Xs,{observedAttributes:mn,styleSheets:gn}));const no=["Red","Green","Purple","Blue","White","Brown","Aqua","Nothing"].map(e=>({text:e}));export{no as a,An as b,lt as c,Js as i,to as l,et as n,mn as o,Qn as u};

import{T as D,f as Ie,B as Cn,E as pt,m as Fe,x as E,i as En,p as Sn,v as J,r as ht,M as jt,_ as zn}from"./iframe-BRm-BSgf.js";/**
 * @license
...
`,Mi=["type","pattern","allowed-pattern","min","max","step","autosize","label",...on],Pi=e=>{const{type:t="text",pattern:n,allowedPattern:i,autocomplete:s,value:o,readonly:r,disabled:l,min:a,max:c,step:h,maxlength:u}=e,{onChange:f,onFocus:d,onInput:b,onRef:p}=nn(e),g=Ti(i);return re({focus:()=>e.shadowRoot?.querySelector("#input")?.focus()},[]),sn(E`
		...
		`,e)};customElements.define("cosmoz-input",lt(Pi,{observedAttributes:Mi,styleSheets:[Gt(rn)]}));const Ce=e=>{e.style.height="",e.style.height=`${e.scrollHeight}px`},Ii=(e,t=0)=>{if(t>0){const n=e.getAttribute("rows")??"",i=e.style.height;e.style.height="",e.setAttribute("rows",t),e.style.maxHeight=e.getBoundingClientRect().height+"px",e.style.height=i,e.setAttribute("rows",n)}},Fi=e=>{const{value:t,maxRows:n}=e,i=R(()=>()=>e.shadowRoot.querySelector("#input"),[]);S(()=>Ii(i(),n),[n,i]),S(()=>Ce(i()),[i,t]),S(()=>{const s=i(),o=new ResizeObserver(()=>requestAnimationFrame(()=>Ce(s)));return o.observe(s),()=>o.unobserve(s)},[i])},Bi=["rows",...on],Di=e=>{const{autocomplete:t,value:n,placeholder:i,readonly:s,disabled:o,rows:r,cols:l,maxlength:a}=e,{onChange:c,onFocus:h,onInput:u,onRef:f}=nn(e);return Fi(e),sn(E`
			<textarea id="input" part="input"
				...
				@change=${c} @focus=${h} @blur=${h}>`,e)};customElements.define("cosmoz-textarea",lt(Di,{observedAttributes:Bi,styleSheets:[Gt(rn)]}));/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ee=e=>!En(e)&&typeof e.then=="function",Se=1073741823;let Hi=class extends Jt{constructor(){super(...arguments),this._$Cwt=Se,this._$Cbt=[],this._$CK=new Vi(this),this._$CX=new Ni}render(...t){return t.find((n=>!Ee(n)))??D}update(t,n){const i=this._$Cbt;let s=i.length;this._$Cbt=n;const o=this._$CK,r=this._$CX;this.isConnected||this.disconnected();for(let l=0;l<n.length&&!(l>this._$Cwt);l++){const a=n[l];if(!Ee(a))return this._$Cwt=l,a;l<s&&a===i[l]||(this._$Cwt=Se,s=0,Promise.resolve(a).then((async c=>{for(;r.get();)await r.get();const h=o.deref();if(h!==void 0){const u=h._$Cbt.indexOf(a);u>-1&&u<h._$Cwt&&(h._$Cwt=u,h.setValue(c))}})))}return D}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const ze=rt(Hi);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Xi=e=>e,Zi=(e,t)=>E`${t}: ${JSON.stringify(e,null,2)}`;class Gi extends Jt{constructor(t){if(super(t),this._virtualizer=null,this._first=0,this._last=-1,this._renderItem=(n,i)=>Zi(n,i+this._first),this._keyFunction=(n,i)=>Xi(n,i+this._first),this._items=[],t.type!==H.CHILD)throw new Error("The virtualize directive can only be used in child expressions")}render(t){t&&this._setFunctions(t);const n=[];if(this._first>=0&&this._last>=this._first)for(let i=this._first;i<=this._last;i++)n.push(this._items[i]);return ji(n,this._keyFunction,this._renderItem)}update(t,[n]){this._setFunctions(n);const i=this._items!==n.items;return this._items=n.items||[],this._virtualizer?this._updateVirtualizerConfig(t,n):this._initialize(t,n),i?D:this.render()}async _updateVirtualizerConfig(t,n){if(!await this._virtualizer.updateLayoutConfig(n.layout||{})){const s=t.parentNode;this._makeVirtualizer(s,n)}this._virtualizer.items=this._items}_setFunctions(t){const{renderItem:n,keyFunction:i}=t;n&&(this._renderItem=(s,o)=>n(s,o+this._first)),i&&(this._keyFunction=(s,o)=>i(s,o+this._first))}_makeVirtualizer(t,n){this._virtualizer&&this._virtualizer.disconnected();const{layout:i,scroller:s,items:o}=n;this._virtualizer=new Ui({hostElement:t,layout:i,scroller:s}),this._virtualizer.items=o,this._virtualizer.connected()}_initialize(t,n){const i=t.parentNode;i&&i.nodeType===1&&(i.addEventListener("rangeChanged",s=>{this._first=s.first,this._last=s.last,this.setValue(this.render())}),this._makeVirtualizer(i,n))}disconnected(){this._virtualizer?.disconnected()}reconnected(){this._virtualizer?.connected()}}const Ji=rt(Gi),ts=(e=HTMLElement)=>class extends e{connectedCallback(){super.connectedCallback?.(),this.dispatchEvent(new CustomEvent("connected"))}disconnectedCallback(){super.disconnectedCallback?.(),this.dispatchEvent(new CustomEvent("disconnected"))}},es=(e,t)=>{if(!e||!t)return;const n=Object.keys(t);return Object.fromEntries(Object.keys(e).flatMap(i=>n.includes(i)?[]:[[i,void 0]]))};class ns extends gt{_props;render(t){return D}update(t,[n]){return this._props!==n&&Object.assign(t.element,es(this._props,n),this._props=n),D}}const is=rt(ns),ss=e=>{const t=Bt(),n=R(()=>new CSSStyleSheet,[]);S(()=>{t.shadowRoot.adoptedStyleSheets=[...t.shadowRoot.adoptedStyleSheets,n]},[]),S(()=>{n.replaceSync(e)},[e])};function os(e){return()=>e}const rs=os(),ls=rs,Lt=e=>e;function to(e,...t){return typeof e=="function"?e(...t):e}function ln(e){return e?t=>t?.[e]:Lt}const as=e=>{const t=ln(e);return n=>typeof n=="string"?n:t(n)?.toString()||""},cs=e=>t=>{const n={};for(const i in t)e.includes(i)&&(n[i]=t[i]);return n},us="data:image/svg+xml,%3Csvg width='11' height='8' viewBox='0 0 11 8' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M9.5 1L5.20039 7.04766L1.66348 3.46152' stroke='white' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E",hs="data:image/svg+xml,%3Csvg width='11' height='11' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 2.5L8.5 8.5M8.5 2.5L2.5 8.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E",ds=zt`
	...
	:host([multi]) .item[data-state='excluded']::before {
		...
		/* prettier-ignore */
		background: url("${hs}") var(--cosmoz-autocomplete-excluded-chip-bg-color, rgb(244, 64, 52)) no-repeat 50%;
	}
...
`,fs=({index:e,itemHeight:t,auto:n})=>zt`
	${et(!n,()=>zt`
			.item {
				line-height: ${t}px;
				height: ${t}px;
...
`,ps=e=>typeof e=="object"&&e!==null&&Symbol.iterator in e;function ot(e){return e==null?[]:Array.isArray(e)?e:typeof e=="string"?[e]:ps(e)?Array.from(e):[e]}const qt=(e,t=Lt)=>n=>{const i=ot(e).map(t);return ot(n).filter(s=>!i.includes(t(s)))},ms=(e,t)=>t?n=>ot(e).find(i=>i[t]===n[t]):n=>ot(e).includes(n),gs=(e,t)=>{if(!t||!e)return e;const n=e.toLowerCase().indexOf(t.toLowerCase());if(n<0)return e;const i=n+t.length;return[e.slice(0,n),E`<mark>${e.slice(n,i)}</mark>`,e.slice(i)]},_t=e=>{const t=R(()=>({}),[]);return R(()=>Object.assign(t,e),[t,...Object.values(e)])},bs=e=>{const t=_t(e);S(()=>{const n=i=>{if(!(i.ctrlKey&&i.altKey||i.defaultPrevented))switch(i.key){case"Up":case"ArrowUp":i.preventDefault(),t.onUp();break;case"Down":case"ArrowDown":i.preventDefault(),t.onDown();break;case"Enter":i.preventDefault(),t.onEnter();break}};return document.addEventListener("keydown",n,!0),()=>document.removeEventListener("keydown",n,!0)},[t])},vs=({items:e,onSelect:t,defaultIndex:n=0})=>{const[i,s]=Q({index:n}),{index:o}=i,{length:r}=e;return S(()=>{s({index:i.index<0?n:Math.min(i.index,e.length-1),scroll:!0})},[e,n]),bs({onUp:x(()=>s(l=>({index:l.index>0?l.index-1:r-1,scroll:!0})),[r]),onDown:x(()=>s(l=>({index:l.index<r-1?l.index+1:0,scroll:!0})),[r]),onEnter:x(()=>o>-1&&o<r&&t?.(e[o],o),[o,e,t])}),{position:i,highlight:x(l=>s({index:l}),[]),select:x(l=>t?.(l),[t])}},_s=(e=Lt)=>(t,n,{highlight:i,select:s,textual:o=Lt,query:r,isSelected:l})=>{const a=o(t),c=gs(a,r),h=e(c,t,n);return E`<div
		...
		<slot></slot>`};customElements.define("cosmoz-listbox",ts(lt(Es,{styleSheets:[ae(ds)]})));const Ss=({multi:e,setFloating:t,styles:n,...i},s)=>E`<cosmoz-listbox
		style="${kn(n)}"
...
`;customElements.define("cosmoz-autocomplete-chip",lt(ks,{observedAttributes:["disabled"],styleSheets:[ae(zs)]}));const As=({content:e,onClear:t,disabled:n,hidden:i,className:s="chip",slot:o})=>E`<cosmoz-autocomplete-chip
		class=${I(s)}
		slot=${I(o)}
		part="chip"
	...
	>`,Rs=({value:e,min:t=0,onDeselect:n,textual:i,disabled:s,chipRenderer:o=As})=>[...e.filter(Boolean).map(r=>o({item:r,content:i(r),onClear:e.length>t&&(()=>n(r)),disabled:s,slot:"control"})),o({item:null,content:E`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],Ls=zt`
	:host {
		display: inline-block;
		vertical-align: middle;

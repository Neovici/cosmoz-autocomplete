import{A as K,s as X,c as O,d as C,b as h,w as ae,f as x,u as ce,a as z,r as Qe,E as M,p as We,D as Je,e as N,h as et,H as tt,n as ot,g as nt,j as Ee,k as rt,l as st,m as it,o as ue,t as at}from"./iframe-CZE-hiBq.js";import{n as y,u as F,a as Q,e as le,i as Te,t as j,f as ct,s as lt,b as Ae,c as G,d as he,w as re,p as se,l as dt,g as pt}from"./index-CbNhJ1vX.js";const m=e=>e??K,W=X(O`
	/*
...
`,At=e=>N(()=>{if(e==null)return;const t=new RegExp(e,"u");return o=>{!o.defaultPrevented&&o.data&&!t.test(o.data)&&o.preventDefault()}},[e]),Ct=et(class extends tt{values;constructor(e,t,o,n){super(e,t),Object.assign(t.host,o),this.values=n}update(e,t){this.hasChanged(t)&&(this.values=t,Object.assign(this.state.host,e))}hasChanged(e=[]){return e.some((t,o)=>this.values[o]!==t)}}),St=/([A-Z])/gu,me=(e,t,o)=>{e[t]=o,e.dispatchEvent(new CustomEvent(t.replace(St,"-$1").toLowerCase()+"-changed",{detail:{value:o}}))},Pe=e=>{const t=F(void 0),o=z(i=>t.current=i,[]),n=e.shadowRoot,s=z(i=>e.dispatchEvent(new Event(i.type,{bubbles:i.bubbles})),[]),r=z(i=>me(e,"value",i.target.value),[]),a=z(i=>me(e,"focused",i.type==="focus"),[]),c=z(()=>{const i=t.current?.checkValidity();return e.toggleAttribute("invalid",!i),i},[]);return Ct({validate:c},[c]),x(()=>{const i=l=>{l.composedPath()[0]?.closest?.("input, textarea")||(l.preventDefault(),t.current?.focus())};return n.addEventListener("mousedown",i),()=>n.removeEventListener("mousedown",i)},[]),{onChange:s,onFocus:a,onInput:r,onRef:o}},Rt=({placeholder:e})=>e||" ",Ot=(e,t)=>t??(e==="date"?"9999-12-31":void 0),Pt=["type","variant","hint","compact","required","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...Re],Lt=e=>{const{type:t="text",pattern:o,allowedPattern:n,autocomplete:s,value:r,readonly:a,disabled:c,min:i,max:l,step:p,maxlength:u,required:w}=e,{onChange:k,onFocus:E,onInput:g,onRef:$}=Pe(e),L=At(n);return e.toggleAttribute("has-value",!!r),Se(h`
			<input
				...
				step=${m(p)}
			/>
		`,e)};customElements.define("cosmoz-input",C(Lt,{observedAttributes:Pt,styleSheets:[X(Oe)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const ve=e=>{e.style.height="",e.style.height=`${e.scrollHeight}px`},It=(e,t=0)=>{if(t>0){const o=e.getAttribute("rows")??"",n=e.style.height;e.style.height="",e.setAttribute("rows",t),e.style.maxHeight=e.getBoundingClientRect().height+"px",e.style.height=n,e.setAttribute("rows",o)}},_t=e=>{const{value:t,maxRows:o}=e,n=N(()=>()=>e.shadowRoot.querySelector("#input"),[]);x(()=>It(n(),o),[o,n]),x(()=>ve(n()),[n,t]),x(()=>{const s=n(),r=new ResizeObserver(()=>requestAnimationFrame(()=>ve(s)));return r.observe(s),()=>r.unobserve(s)},[n])},qt=["rows","placeholder","label","hint","required",...Re],Nt=e=>{const{autocomplete:t,value:o,placeholder:n,readonly:s,disabled:r,rows:a,cols:c,maxlength:i}=e,{onChange:l,onFocus:p,onInput:u,onRef:w}=Pe(e);return _t(e),Se(h`
			<textarea id="input" part="input"
				...
				@change=${l} @focus=${p} @blur=${p}>`,e)};customElements.define("cosmoz-textarea",C(Nt,{observedAttributes:qt,styleSheets:[X(Oe)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const Mt=e=>{const{label:t,value:o,disabled:n,error:s}=e,r=z(a=>e.dispatchEvent(new CustomEvent("change",{detail:a.target.checked})),[]);return h`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
		...
		<slot name="suffix"></slot>
		${y(s,a=>h`<div class="failure">${a}</div>`)} `},Yt=O`
	.toggle {
		appearance: none;
...
`;customElements.define("cosmoz-toggle",C(Mt,{styleSheets:[Bt,Yt],observedAttributes:["label","disabled","error"]}));const Dt={},fe=le(class extends Te{constructor(){super(...arguments),this.ot=Dt}render(e,t){return t()}update(e,[t,o]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every((n,s)=>n===this.ot[s]))return M}else if(this.ot===t)return M;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,o)}});class jt{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}class Ft{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise(t=>this.Z=t)}resume(){this.Z?.(),this.Y=this.Z=void 0}}const be=e=>!ot(e)&&typeof e.then=="function",ze=1073741823;class Ut extends ct{constructor(){super(...arguments),this._$Cwt=ze,this._$Cbt=[],this._$CK=new jt(this),this._$CX=new Ft}render(...t){return t.find(o=>!be(o))??M}update(t,o){const n=this._$Cbt;let s=n.length;this._$Cbt=o;const r=this._$CK,a=this._$CX;this.isConnected||this.disconnected();for(let c=0;c<o.length&&!(c>this._$Cwt);c++){const i=o[c];if(!be(i))return this._$Cwt=c,i;c<s&&i===n[c]||(this._$Cwt=ze,s=0,Promise.resolve(i).then(async l=>{for(;a.get();)await a.get();const p=r.deref();if(p!==void 0){const u=p._$Cbt.indexOf(i);u>-1&&u<p._$Cwt&&(p._$Cwt=u,p.setValue(l))}}))}return M}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const ye=le(Ut),Ht=({content:e,onClear:t,disabled:o,className:n="chip",hidden:s,slot:r})=>h`<cosmoz-tag
		class=${m(n)}
		slot=${m(r)}
		...
		>${e}</cosmoz-tag
	>`,Zt=({value:e,min:t=0,onDeselect:o,textual:n,disabled:s,chipRenderer:r=Ht})=>[...e.filter(Boolean).map(a=>r({item:a,content:n(a),onClear:e.length>t&&(()=>o(a)),disabled:s,slot:"control"})),r({item:null,content:h`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],Vt=O`
	:host {
		display: inline-block;
		vertical-align: middle;
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",C(()=>K,{styleSheets:[Vt]}));const Gt=Ce`
	:host {
		display: block;
		position: relative;

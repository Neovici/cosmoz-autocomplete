import{b as Y}from"./iframe-DNX8MRif.js";import"./index-DcY5l3t5.js";import"./preload-helper-PPVm8Dsz.js";import"./index-7LlRy4aB.js";const{expect:a,fn:p,userEvent:c,waitFor:i}=__STORYBOOK_MODULE_TEST__,U=({source:e,value:o,limit:t,textProperty:n="text",valueProperty:l,onChange:r,onText:u,onSelect:D,disabled:L,defaultIndex:$,text:N,keepOpened:V,externalSearch:M,lazyOpen:_,preserveOrder:j,required:K})=>Y`
    <cosmoz-autocomplete
        .source=${e}
        .value=${o}
        .limit=${t}

...
`,j=(e,a)=>a==null?e:({active:t})=>t?new Promise(s=>setTimeout(()=>s(e),a)):void 0,N=({source:e,limit:a,textProperty:t,min:s,label:v="",value:S=[],disabled:B=!1,placeholder:T="",defaultIndex:k=0,showSingle:z=!1,preserveOrder:P=!1,wrap:C=!1,keepOpened:$=!1,keepQuery:R=!1,opened:E=!1,overflowed:O=!1,responseTime:I,contour:q,lazyOpen:W})=>{const A={maxWidth:O?"170px":"initial"},D=j(e,I);return b`
        ${M}
        <cosmoz-autocomplete
            class=${g(q,()=>"contour")}
            .label=${v}
    ...
    `},x={args:{label:"Choose color",source:o,textProperty:"text",value:[o[0],o[3]]},play:async({canvas:e,step:a})=>{await a("Renders with initial value",async()=>{const t=document.querySelector("cosmoz-autocomplete");r(t).toBeTruthy(),await e.findByShadowText(/Red/u),await e.findByShadowText(/Blue/u)}),await a("Remove chips and select new item",async()=>{const t=await e.findByShadowRole("textbox");await n.click(t),await n.keyboard("{Backspace}{Backspace}"),await n.type(t,"Wh"),await n.keyboard("{Enter}"),await e.findByShadowText(/White/u)}),await a("No results message",async()=>{const t=await e.findByShadowRole("textbox");await n.click(t),await n.tripleClick(t),await n.type(t,"Asdf"),await e.findByShadowText(/No results found/u)})}},f={args:{label:"Start typing to see results",source:o,textProperty:"text",lazyOpen:!0}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Choose color',
    source: colors,
    textProperty: 'text',
...
}`,...f.parameters?.docs?.source}}};const G=["Basic","Single","DefaultIndex","DefaultIndexSingleValue","Disabled","Placeholder","Select","Overflown","Wrap","AccentInsensitiveSearch","InteractionTest","LazyOpen"];export{w as AccentInsensitiveSearch,i as Basic,l as DefaultIndex,d as DefaultIndexSingleValue,m as Disabled,x as InteractionTest,f as LazyOpen,y as Overflown,u as Placeholder,p as Select,c as Single,h as Wrap,G as __namedExportsOrder,F as default};

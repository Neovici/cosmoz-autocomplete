...
`,j=(e,a)=>a==null?e:({active:t})=>t?new Promise(i=>setTimeout(()=>i(e),a)):void 0,N=({source:e,limit:a,textProperty:t,min:i,label:v="",value:S=[],disabled:B=!1,placeholder:T="",defaultIndex:k=0,showSingle:z=!1,preserveOrder:P=!1,wrap:C=!1,keepOpened:$=!1,keepQuery:R=!1,opened:E=!1,overflowed:q=!1,responseTime:I,contour:W,minLength:O})=>{const A={maxWidth:q?"170px":"initial"},L=j(e,I);return g`
        ${_}
        <cosmoz-autocomplete
            class=${b(W,()=>"contour")}
            .label=${v}
...
}`,...f.parameters?.docs?.source}}};const G=["Basic","Single","DefaultIndex","DefaultIndexSingleValue","Disabled","Placeholder","Select","Overflown","Wrap","AccentInsensitiveSearch","InteractionTest","MinLength"];export{w as AccentInsensitiveSearch,s as Basic,l as DefaultIndex,d as DefaultIndexSingleValue,m as Disabled,x as InteractionTest,f as MinLength,y as Overflown,u as Placeholder,p as Select,c as Single,h as Wrap,G as __namedExportsOrder,F as default};

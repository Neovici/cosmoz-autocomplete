import{b as i,A as R}from"./iframe-C_VsEvHI.js";import{c as _,u as h,a as m,i as j,b as L,s as M,o as D,A as q,d as x,e as f,f as g,n as v,g as G}from"./data-DqPK0Sfc.js";const Q="data:image/svg+xml,%3Csvg width='11' height='11' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 2.5L8.5 8.5M8.5 2.5L2.5 8.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E",W=_`
...
`,b=o=>({item:o,excluded:!1}),y=o=>o.item,F=o=>{const[e,t]=h(o),r=m(a=>t(s=>{const l=j(a,s?.map(y));if(!l)return;if(!s)return l.map(b);const c=s.reduce((n,d)=>l.includes(d.item)?[...n,d]:d.excluded?n:[...n,{...d,excluded:!0}],[]),u=l.filter(n=>!s.some(d=>d.item===n)).map(b);return[...c,...u]}),[]);return{value:e,setExcludingValue:r,setValue:t}},H=(o,e)=>o?.some(t=>t.item===e&&t.excluded),$=(o,e)=>e&&H(o,e)?"excluded":R,J=o=>(e,t,{highlight:r,select:a,textual:s,isSelected:l})=>{const c=s(e);return i`<div
				class="item"
				role="option"
				part="option ${$(o,e)}"
				?aria-selected=${l(e)}

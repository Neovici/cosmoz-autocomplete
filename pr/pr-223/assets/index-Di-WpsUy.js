...
`,Je=e=>{const{placement:t="bottom span-right",openOnHover:o,openOnFocus:n}=e,a=G(),s=()=>a.current?.showPopover(),r=()=>a.current?.hidePopover(),i=()=>a.current?.togglePopover();return Ke({host:e,popoverRef:a,openOnHover:o,openOnFocus:n,open:s,close:r}),u`
	...
	`};customElements.define("cosmoz-dropdown-next",k(Je,{styleSheets:[We],observedAttributes:["placement","open-on-hover","open-on-focus"],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const f=e=>e??Z;const M=ce(class extends Ne{constructor(e){if(super(e),e.type!==I.PROPERTY&&e.type!==I.ATTRIBUTE&&e.type!==I.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Oe(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===P||t===Z)return t;const o=e.element,n=e.name;if(e.type===I.PROPERTY){if(t===o[n])return P}else if(e.type===I.BOOLEAN_ATTRIBUTE){if(!!t===o.hasAttribute(n))return P}else if(e.type===I.ATTRIBUTE&&o.getAttribute(n)===t+"")return P;return Ie(e),t}}),ue=(e,{label:t,invalid:o,errorMessage:n})=>u`

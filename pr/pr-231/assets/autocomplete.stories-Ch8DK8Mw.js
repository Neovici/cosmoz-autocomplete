import{b as L}from"./iframe-DhWnNLJR.js";import"./index-C1gKyqop.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DQ0i4sI8.js";const{expect:n,fn:i,userEvent:c,waitFor:l}=__STORYBOOK_MODULE_TEST__,I=({source:e,value:t,limit:a,textProperty:s="text",valueProperty:r,onChange:q,onText:E,onSelect:z,disabled:O,defaultIndex:A,text:F,keepOpened:H,externalSearch:W})=>L`
    <cosmoz-autocomplete
        .source=${e}
        .value=${t}
        .limit=${a}

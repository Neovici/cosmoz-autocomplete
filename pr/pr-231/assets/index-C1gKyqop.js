import{f as b,c as D,d as A,u as X,a as h,b as m,A as Z,r as je,E as C,p as qe,e as k,h as Be,H as Fe,s as pe,n as De,g as Me,j as de,k as Ne,l as He,m as V,t as Ue}from"./iframe-DhWnNLJR.js";import{u as G,a as K,e as Q,i as ue,t as P,n as E,f as Xe,s as he,b as Ze,c as me,d as H,g as Ge,w as U,p as Ke,l as Qe}from"./index-DQ0i4sI8.js";const M=(e,...t)=>e.flatMap((o,n)=>[o,t[n]??""]).join(""),We=({host:e,popoverRef:t,openOnHover:o,openOnFocus:n,open:r,close:s})=>{const a=G(),l=()=>clearTimeout(a.current),i=()=>{clearTimeout(a.current),a.current=setTimeout(()=>{const c=t.current;o&&(e.matches(":hover")||c?.matches(":hover"))||n&&(e.matches(":focus-within")||c?.matches(":focus-within"))||s()},100)},d=()=>{l(),r()};b(()=>{if(o)return e.addEventListener("pointerenter",d),e.addEventListener("pointerleave",i),()=>{l(),e.removeEventListener("pointerenter",d),e.removeEventListener("pointerleave",i)}},[o,e]),b(()=>{if(n)return e.addEventListener("focusin",d),e.addEventListener("focusout",i),()=>{l(),e.removeEventListener("focusin",d),e.removeEventListener("focusout",i)}},[n,e])},Je=e=>{if(e.newState!=="open")return;const n=e.target.querySelector("slot:not([name])")?.assignedElements({flatten:!0})??[];for(const r of n){const s=r.matches("[autofocus]")?r:r.querySelector("[autofocus]");if(s instanceof HTMLElement){s.focus();break}}},Ve=D`
	:host {

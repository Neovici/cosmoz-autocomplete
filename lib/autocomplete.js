...
const
	...
	renderSuggestions = ({ defaultIndex, itemLimit, ...thru }) => portal(html`<cosmoz-suggestions ...=${ spreadProps({
		...props(['query', 'items', 'onSelect', 'textual', 'anchor', 'confinement', 'placement', 'itemHeight'])(thru),
		limit: itemLimit,

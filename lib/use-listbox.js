...
import { usePosition } from '@neovici/cosmoz-dropdown/src/use-position';
...
const useItems = ({
	...
	properties = ['query', 'items', 'onSelect', 'textual', 'anchor', 'confinement', 'placement', 'itemHeight', 'itemLimit', 'defaultIndex', 'value', 'styles'];

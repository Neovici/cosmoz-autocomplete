...
`,_=(e,a)=>a==null?e:({active:n})=>n?new Promise(i=>setTimeout(()=>i(e),a)):void 0,L=({source:e,limit:a,textProperty:n,min:i,label:g="",value:v=[],disabled:S=!1,placeholder:B="",defaultIndex:T=0,showSingle:k=!1,preserveOrder:z=!1,wrap:C=!1,keepOpened:P=!1,keepQuery:$=!1,overflowed:R=!1,responseTime:E,contour:I})=>{const q={maxWidth:R?"170px":"initial"},W=_(e,E);return f`
        ${H}
        <cosmoz-autocomplete
            class=${b(I,()=>"contour")}
            .label=${g}

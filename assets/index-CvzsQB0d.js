import{f as v,c as F,d as C,u as X,a as h,b as m,A as Z,r as Ye,E as $,p as je,e as z,h as qe,H as Be,s as de,n as Fe,g as De,j as pe,k as Me,l as Ne,m as V,t as He}from"./iframe-BPVfX7h5.js";import{u as G,a as K,e as Q,i as ue,t as I,n as k,f as Ue,s as he,b as Xe,c as me,d as H,g as Ze,w as U,p as Ge,l as Ke}from"./index-C5MpP_U2.js";const D=(e,...t)=>e.flatMap((o,n)=>[o,t[n]??""]).join(""),Qe=({host:e,popoverRef:t,openOnHover:o,openOnFocus:n,open:r,close:s})=>{const a=G(),l=()=>clearTimeout(a.current),i=()=>{clearTimeout(a.current),a.current=setTimeout(()=>{const c=t.current;o&&(e.matches(":hover")||c?.matches(":hover"))||n&&(e.matches(":focus-within")||c?.matches(":focus-within"))||s()},100)},p=()=>{l(),r()};v(()=>{if(o)return e.addEventListener("pointerenter",p),e.addEventListener("pointerleave",i),()=>{l(),e.removeEventListener("pointerenter",p),e.removeEventListener("pointerleave",i)}},[o,e]),v(()=>{if(n)return e.addEventListener("focusin",p),e.addEventListener("focusout",i),()=>{l(),e.removeEventListener("focusin",p),e.removeEventListener("focusout",i)}},[n,e])},We=e=>{if(e.newState!=="open")return;const n=e.target.querySelector("slot:not([name])")?.assignedElements({flatten:!0})??[];for(const r of n){const s=r.matches("[autofocus]")?r:r.querySelector("[autofocus]");if(s instanceof HTMLElement){s.focus();break}}},Je=F`
	:host {

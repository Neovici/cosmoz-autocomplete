import{c as H,u as b,a as h,i as L,d as M,e as w,b as m,A as j}from"./iframe-DdIqWP81.js";import{c as p,o as D}from"./data-Dc2FR_Du.js";import{n as v}from"./index-DLcblExt.js";import{s as F,o as N,A as G,a as y}from"./index-VBaD6AYf.js";import"./preload-helper-PPVm8Dsz.js";const K="data:image/svg+xml,%3Csvg width='11' height='11' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 2.5L8.5 8.5M8.5 2.5L2.5 8.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E",Q=H`
...
`,f=o=>({item:o,excluded:!1}),T=o=>o.item,U=o=>{const[e,t]=b(o),c=h(r=>t(s=>{const l=L(r,s?.map(T));if(!l)return;if(!s)return l.map(f);const a=s.reduce((n,u)=>l.includes(u.item)?[...n,u]:u.excluded?n:[...n,{...u,excluded:!0}],[]),i=l.filter(n=>!s.some(u=>u.item===n)).map(f);return[...a,...i]}),[]);return{value:e,setExcludingValue:c,setValue:t}},W=(o,e)=>o?.some(t=>t.item===e&&t.excluded),k=(o,e)=>e&&W(o,e)?"excluded":j,Y=o=>(e,t,{highlight:c,select:r,textual:s,isSelected:l})=>{const a=s(e);return m`<div
		...
		>
			${c}
		</cosmoz-autocomplete-chip>`,X=o=>{const{value:e,setValue:t,setExcludingValue:c}=U("value"),[r,s]=b("text"),l=h(a=>t(i=>i?.filter(n=>n.item!==a)),[]);return G({...o,value:w(()=>e?.map(T),[e]),onChange:h(a=>{c(a)},[]),text:r,onText:h(a=>{s(a)},[]),itemRenderer:w(()=>Y(e),[e]),chipRenderer:w(()=>J(e,l),[e,l])})},Z={mode:"open",delegatesFocus:!0};customElements.define("cosmoz-autocomplete-excluding",M(X,{observedAttributes:N,styleSheets:[F,Q],shadowRootInit:Z}));const{expect:S,userEvent:d,waitFor:ee}=__STORYBOOK_MODULE_TEST__,oe=m`
    <style>
        .custom-message {
            font-size: 14px;
            font-weight: 500;
...
`,te=(o,e)=>e==null?o:({active:t})=>t?new Promise(c=>setTimeout(()=>c(o),e)):void 0,ce=({source:o,limit:e,textProperty:t,min:c,label:r="",value:s=[],disabled:l=!1,placeholder:a="",defaultIndex:i=0,showSingle:n=!1,preserveOrder:u=!1,wrap:z=!1,keepOpened:$=!1,keepQuery:C=!1,overflowed:B=!1,responseTime:E,contour:R,excludedBgColor:O,excludedChipColor:A,excludedChipClearBgColor:V,excludedChipClearStrokeColor:q,excludedListboxActiveColor:_})=>{const I={maxWidth:B?"170px":"initial","--cosmoz-autocomplete-excluded-bg-color":O,"--cosmoz-autocomplete-excluded-chip-color":A,"--cosmoz-autocomplete-excluded-chip-clear-bg-color":V,"--cosmoz-autocomplete-excluded-chip-clear-stroke":q,"--cosmoz-listbox-excluded-active-color":_},P=te(o,E);return m`
        ${oe}
...
}`,...g.parameters?.docs?.source}}};const ie=["Basic","InteractionTest"];export{x as Basic,g as InteractionTest,ie as __namedExportsOrder,ue as default};

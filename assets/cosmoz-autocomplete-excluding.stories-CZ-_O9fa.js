import{E as R,x as i}from"./iframe-Cyv2tdxv.js";import{u as h,a as m,i as _,c as j,b as L,s as M,o as D,A as q,d as x,e as f,n as v,f as b,g as G}from"./data-BwCQNDrT.js";const g=o=>({item:o,excluded:!1}),y=o=>o.item,Q=o=>{const[e,t]=h(o),r=m(a=>t(s=>{const l=_(a,s?.map(y));if(!l)return;if(!s)return l.map(g);const c=s.reduce((n,d)=>l.includes(d.item)?[...n,d]:d.excluded?n:[...n,{...d,excluded:!0}],[]),u=l.filter(n=>!s.some(d=>d.item===n)).map(g);return[...c,...u]}),[]);return{value:e,setExcludingValue:r,setValue:t}},W="data:image/svg+xml,%3Csvg width='11' height='11' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 2.5L8.5 8.5M8.5 2.5L2.5 8.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E",F=j`
...
`,X=(o,e)=>e==null?o:({active:t})=>t?new Promise(r=>setTimeout(()=>r(o),e)):void 0,Y=({source:o,limit:e,textProperty:t,min:r,label:a="",value:s=[],disabled:l=!1,placeholder:c="",defaultIndex:u=0,showSingle:n=!1,preserveOrder:d=!1,wrap:z=!1,keepOpened:k=!1,keepQuery:w=!1,overflowed:C=!1,responseTime:T,contour:E,excludedBgColor:S,excludedChipColor:A,excludedChipClearBgColor:V,excludedChipClearStrokeColor:B,excludedListboxActiveColor:I})=>{const P={maxWidth:C?"170px":"initial","--cosmoz-autocomplete-excluded-bg-color":S,"--cosmoz-autocomplete-excluded-chip-color":A,"--cosmoz-autocomplete-excluded-chip-clear-bg-color":V,"--cosmoz-autocomplete-excluded-chip-clear-stroke":B,"--cosmoz-listbox-excluded-active-color":I},O=X(o,T);return i`
        ${U}

import{E as R,x as i}from"./iframe-Dw6xcovl.js";import{u as h,a as m,i as _,c as j,b as L,s as M,o as D,A as q,d as x,e as f,n as v,f as b,g as G}from"./data-rfCzvrBB.js";const g=o=>({item:o,excluded:!1}),y=o=>o.item,Q=o=>{const[e,t]=h(o),r=m(a=>t(s=>{const l=_(a,s?.map(y));if(!l)return;if(!s)return l.map(g);const c=s.reduce((n,d)=>l.includes(d.item)?[...n,d]:d.excluded?n:[...n,{...d,excluded:!0}],[]),u=l.filter(n=>!s.some(d=>d.item===n)).map(g);return[...c,...u]}),[]);return{value:e,setExcludingValue:r,setValue:t}},W="data:image/svg+xml,%3Csvg width='11' height='11' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 2.5L8.5 8.5M8.5 2.5L2.5 8.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E",F=j`
